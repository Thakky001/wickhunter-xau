...
| `TRIGGERED` | เบรกปลายไส้สำเร็จ ส่งจุด Entry / SL / TP |
...
> **หัวตาราง:** ไม่ต้องพิมพ์เอง — ตอนสตาร์ทเซิร์ฟเวอร์ ถ้าแถว 1 ว่าง ระบบจะใส่ให้อัตโนมัติ
...
| `TRIGGERED` | เบรกแล้ว ส่งสัญญาณเต็มรูปแบบ แล้วรอ 5 นาทีก่อนสแกนใหม่ |
